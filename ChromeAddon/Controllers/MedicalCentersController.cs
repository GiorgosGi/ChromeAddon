...
namespace TestGrPr.Controllers
{
    public class MedicalCentersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,MedicalCenterName,Address,City,PhoneNumber,Email,AreaCode")] MedicalCenter medicalCenter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,MedicalCenterName,Address,City,PhoneNumber,Email,AreaCode")] MedicalCenter medicalCenter)
        {
            if (ModelState.IsValid)
            {
